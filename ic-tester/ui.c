...
uint8_t package;			// сколько выводов у микросхемы (ручной тест). тут же хранит€ тип микросхемы (TTL/CMOS)
...
void Draw() {
	...
	glcd_update_bbox(0, 0, GLCD_LCD_WIDTH-1, GLCD_LCD_HEIGHT-1);	// костыль дл€ некоторых дисплеев
	glcd_write();
}
